...
function DashBoardLayoutView(){
    ...
    return(
        <Box className="flex flex-col gap-y-3" mt={2}>
            <Box sx={{ boxShadow: 1 }}>
                <Container>
                    <Box>
                        <Typography fontWeight={'normal'} textAlign='center' variant="h4">Tu mejor opcion para conseguir un trabajo angel cricko</Typography>
            ...
            <Box >
                <Container disableGutters={!md}>
                    <Box>
                        <Typography fontWeight={'normal'} className="text-gray-800" textAlign='center' variant="h4">Explora nuevos talentos</Typography>
                        <Typography fontWeight={'normal'} className="text-gray-600" textAlign='center' variant="h6">Conecta con profesionales listos para trabajar</Typography>
                    </Box>
                    <Grid direction={md ? "row" : "column-reverse"} container sx={{borderRadius: "20px", marginBottom: "20px"}}>
                        <Grid size={{xs: 12 , md : 6}}>
                            <Box height="1" sx={ md ? {borderBottomLeftRadius: "20px", borderTopLeftRadius: "20px", backgroundColor: "#3B82F6"} : {borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", backgroundColor: "#3B82F6"} } className={""}>
                                <Box className={"flex flex-col justify-center p-4"}>
                                    <Typography variant={'h6'} className="text-white" fontWeight={400}>Accesible</Typography>
                                    <Box>
                                        <Typography variant={'h2'} className="text-white" fontWeight={400}>Contrata Talentos</Typography>
                                        <Typography variant={'h6'} className="text-white" fontWeight={400}>Conecta con profesionales calificados y descubre personas comprometidas con brindar soluciones reales.
                                            Desde servicios especializados hasta trabajos por proyecto, aquí puedes encontrar y contratar a quien necesitas,  <Typography component="span"></Typography> cuando lo necesitas.</Typography>
                                        <Box className="flex gap-x-2" alignItems={md ? "center" : ""}>
                                            <Icon sx={{color: '#FFFFFF'}}>speed</Icon>
                                            <Typography fontSize={18} className="text-white"  variant="h6" >Rapido.
                                                <Typography fontSize={18} fontWeight={'lighter'} component={'span'}> Encuentra rapido lo que necesites.</Typography>
                                            </Typography>
                                        </Box>
                                        <Box className="flex gap-x-2" alignItems={md ? "center" : ""}>
                                            <Icon sx={{color: '#FFFFFF'}}>explore</Icon>
                                            <Typography fontSize={18} className="text-white" variant="h6" >Cerca de ti.
                                                <Typography fontSize={18} fontWeight={'lighter'} component={'span'}> Encuentra personas a tus necesidades.</Typography>
                                            </Typography>
                                        </Box>
                                        <Box className="flex gap-x-2" alignItems={md ? "center" : ""}>
                                            <Icon sx={{color: '#FFFFFF'}}>handshake</Icon>
                                            <Typography fontSize={18} className="text-white" variant="h6" >Ofrece.
                                                <Typography fontSize={18} fontWeight={'lighter'}  component={'span'}> Muestra tus habilidades.</Typography>
                                            </Typography>
                                        </Box>
                                        <Box sx={{display: "flex", justifyContent: "center", marginTop: "10px"}}>
                                            <Button variant="contained" sx={{borderRadius: "10px", backgroundColor: "#2563EB", color: "white",}}>Como funciona</Button>
                                        </Box>
                                    </Box>
                                </Box>
                            </Box>
                        ...
                        <Grid size={{xs: 12 , md : 6}}>
                            <Box
                                sx={ md ? {borderBottomRightRadius: "20px", borderTopRightRadius: "20px"} : {borderTopLeftRadius: "20px", borderTopRightRadius: "20px"} }
                                component="img"
                                width="100%"
                                height={"100%"}
                                src="/src/assets/workVisit.jpg"
                                alt="Work visit"/>
                        </Grid>
                    </Grid>

                    <Box sx={{
                        backgroundImage: "url(/src/assets/visit4.jpg)",
                        backgroundColor: "#ECEFF1",
                        backgroundRepeat: 'no-repeat',
                        backgroundSize: 'cover',
                        backgroundPosition: 'center center',
                        height: md ? "700px" : "auto",
                        padding: "20px",
                    }}>
                        <Typography variant={'h6'} className="text-white" fontWeight={400}>Contratacion</Typography>
                        <Box className={`flex flex-col justify-between h-[90%]`}>
                            <Box>
                                <Typography fontSize={60} className="text-white" fontWeight={400}>Contrata Personas</Typography>
                                <Typography fontSize={30} className="text-white" fontWeight={450}>Haz crecer tu negocio o resuelve tus tareas pendientes contratando personas confiables, profesionales y cercanas. Encuentra desde freelancers hasta especialistas para cualquier tipo de servicio, sin complicaciones.s</Typography>
                            </Box>

                            <Grid container direction={md ? "row" : "column"} spacing={2}>
                                <Grid size={{xs : 12, md : 4}} >
                                    <Card sx={{backgroundColor: "#3B82F6"}} className={`${md ? "w-[300px]" : "w-full"} max-w-[95%] h-[100px] ${md ? "h-[200px]" : "h-[100px]"} bg-blue-600 rounded-xl`}>
                                        <CardActionArea sx={{height: "100%", padding: "10px", display: "flex", flexDirection: "column", alignItems: "center"}}>
                                            <CardContent className={`flex ${md ? "flex-col" : "flex-row"} ${md ? "" : "items-center"} w-full  h-full justify-between`}>
                                                <Typography className="text-white" variant={md ? "h4" : "h5"}>Crea una publicacion</Typography>
                                                <Box className="flex items-center gap-x-2">
                                                    <Typography className="text-white">Publicaciones</Typography>
                                                    <Icon className="text-white" sx={{fontSize: 30}}>arrow_forward</Icon>
                                                </Box>
                                            </CardContent>
                                        </CardActionArea>
                                    </Card>
                                ...
                                <Grid size={{xs : 12, md : 4}} >
                                    <Card sx={{backgroundColor: "#3B82F6"}} className={`${md ? "w-[300px]" : "w-full"} max-w-[95%] h-[100px] ${md ? "h-[200px]" : "h-[100px]"} bg-blue-600 rounded-xl`}>
                                        <CardActionArea sx={{height: "100%", padding: "10px", display: "flex", flexDirection: "column", alignItems: "center"}}>
                                            <CardContent className={`flex ${md ? "flex-col" : "flex-row"} ${md ? "" : "items-center"} w-full  h-full justify-between`}>
                                                <Typography className="text-white" variant={md ? "h4" : "h5"}>Busca perfiles de personas</Typography>
                                                <Box className="flex items-center gap-x-2">
                                                    <Typography className="text-white">Ir a buscar perfiles</Typography>
                                                    <Icon className="text-white" sx={{fontSize: 30}}>arrow_forward</Icon>
                                                </Box>
                                            </CardContent>
                                        </CardActionArea>
                                ...
                                <Grid size={{xs : 12, md : 4}} >
                                    <Card sx={{backgroundColor: "#3B82F6"}} className={`${md ? "w-[300px]" : "w-full"} max-w-[95%] h-[100px] ${md ? "h-[200px]" : "h-[100px]"} bg-blue-600 rounded-xl`}>
                                        <CardActionArea sx={{height: "100%", padding: "10px", display: "flex", flexDirection: "column", alignItems: "center"}}>
                                            <CardContent className={`flex ${md ? "flex-col" : "flex-row"} ${md ? "" : "items-center"} w-full  h-full justify-between`}>
                                                <Typography className="text-white" variant={md ? "h4" : "h5"}>Registra tu empresa</Typography>
                                                <Box className="flex items-center gap-x-2">
                                                    <Typography className="text-white">Ir a registrar mi empresa</Typography>
                                                    <Icon className="text-white" sx={{fontSize: 30}}>arrow_forward</Icon>
                                                </Box>
                                            </CardContent>
                                        </CardActionArea>
